...
class DrawingBoard extends StatefulWidget {
  ...
  static List<DefToolItem> defaultTools(
    ...
    return <DefToolItem>[
      DefToolItem(
          onClick: () {
            Get.find<SelectedToolController>().selectedToolName.value =
                "Pencil";
      ...
      DefToolItem(
          onClick: () {
            Get.find<SelectedToolController>().selectedToolName.value = "Brush";
            Get.find<SelectedToolController>().update();
          },
      ...
      DefToolItem(
          onClick: () {
            Get.find<SelectedToolController>().selectedToolName.value = "Line";
            Get.find<SelectedToolController>().update();
          },
            ...
            return Container(
              ...
              child: ListView(
                ...
                children: (widget.defaultToolsBuilder
                    ...
                    .map((DefToolItem item) => DefToolItemWidget(item: item))
                    .toList(),
                // ======================================================================================
              ),
            );
...
class DefToolItem {
  DefToolItem({
    ...
    this.activeColor = const Color(0xff1B84B4),
    this.iconSize,
  });
...
/// 默认工具项 Widget
class DefToolItemWidget extends StatelessWidget {
  const DefToolItemWidget({
    required this.item,
  });
        ...
        child: Column(
          ...
          children: [
            ...
            Icon(
              item.icon,
              color: item.color,
              // color: item.isActive == true ? item.activeColor : item.color,
              size: 36,
            ),
            Text(
              item.name,
