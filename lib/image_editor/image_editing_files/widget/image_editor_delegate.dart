import 'package:editor_demo/image_editor/image_editing_files/widget/float_text_widget.dart';
...
class DefaultImageEditorDelegate extends ImageEditorDelegate {
  Color operatorStatuscolor(bool choosen) =>
      choosen ? const Color(0xffffffff) : Colors.white;
  ...
  @override
  Widget settingWidget(double limitSize, OperateType type,
      {required bool choosen}) {
    return Icon(Icons.edit_square,
        size: limitSize, color: operatorStatuscolor(choosen));
  }
}
...
abstract class ImageEditorDelegate {
  ...
  final double _operateBtnSize = 36;
  ...
  Widget buildOperateWidget(OperateType type, {required bool choosen}) {
    switch (type) {
      ...
      case OperateType.setting:
        return settingWidget(_operateBtnSize, type, choosen: choosen);
